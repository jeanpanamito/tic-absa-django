"""
Django settings for tic_absa_project.
"""
...
ROOT_URLCONF = 'tic_absa_project.urls'
...
WSGI_APPLICATION = 'tic_absa_project.wsgi.application'

# Database — SQLite for Django internals only (Neo4j is the main analytical DB)
DATABASES = {
    'default': {
